...
import Offcanvas2 from '@/components/common/Offcanvas';

import light_logo from "@/assets/img/logo/logo-2.png";
              ...
              <div className="col-xl-2 col-lg-2 col-md-5 col-6">
                <div className="logo">
                  <Link className="logo-white" href="/">
                    <Image style={{ width: '130px', height: 'auto' }} src={light_logo} alt="Devansh Mistry Logo" />
                  </Link>
                  <Link className="logo-black" href="/">
                    <Image style={{ width: '130px', height: 'auto' }} src={dark_logo} alt="Devansh Mistry Logo" />
                  </Link>
                </div>
              </div>
