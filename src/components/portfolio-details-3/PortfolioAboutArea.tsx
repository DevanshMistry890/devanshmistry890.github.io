...
const portfolio_content = {
  ...
  title: "Serverless, Private AI: Running NLP Models Directly in the Browser.",
  description: "This project demonstrates the power of Edge AI by running complex Natural Language Processing tasks entirely client-side. By leveraging Transformers.js and WebAssembly, this application analyzes text sentiment, translates languages, and classifies data without sending a single byte to a server. This approach ensures 100% data privacy, zero latency from API calls, and zero server costs.",
}
            ...
            <div className="col-xl-5 col-lg-4">
              <div className="porfolio-details__left-info">
                ...
                <div className="porfolio-details__left-content">
                  ...
                  <span>Transformers.js (ONNX)</span>
            ...
            <div className="col-xl-7 col-lg-8">
              <div className="porfolio-details__right-info">
                ...
                <div className="porfolio-details__right-btn">
                  <a className="tp-btn-border-md" href="https://github.com/DevanshMistry890/edge-nlp-analyzer" target="_blank" rel="noopener noreferrer">
                    View Code/Demo
