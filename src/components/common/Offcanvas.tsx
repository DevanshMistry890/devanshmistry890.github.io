  ...
  return (
    <>
      <div className={`tp-offcanvas-area  ${showCanvas ? 'opened' : ''} `}>
        <div className="tp-offcanvas-bg is-left theme-bg-2"></div>
        <div className="tp-offcanvas-bg is-right d-none d-md-block theme-bg-2">
          ...
          <div className="tp-offcanvas-right d-none d-md-block">
            ...
            <div className="tp-offcanvas-right-inner d-flex flex-column justify-content-between h-100">
              ...
              <div className="tpoffcanvas__social-link">
                <ul>
                  <li><a href="https://github.com/DevanshMistry890" target="_blank" rel="noopener noreferrer">Github</a></li>
                  <li><a href="https://www.linkedin.com/in/devansh-mistry/" target="_blank" rel="noopener noreferrer">Linkedin</a></li>
                </ul>
              </div>
            </div>
          </div>
