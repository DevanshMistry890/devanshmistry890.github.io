...
const contact_content: DataType = {
  subtitle: "Contact Me",
  title_1: "Let’s Build",
  title_2: "Intelligent Solutions",
  email: "devanshmistry890@gmail.com",
  mail_text: <>Have a complex data problem or need an <br /> AI-powered application? Let's connect.</>,
  categorys: [
    { id: "ai_llm", title: "AI & LLM Integration" },
    { id: "web_dev", title: "Fullstack Web Dev" },
    { id: "rag_systems", title: "RAG Systems" },
    { id: "data_science", title: "Data Science & Analytics" },
    { id: "mlops", title: "MLOps & Deployment" },
    { id: "consulting", title: "Tech Consultation" },
    { id: "mvp_build", title: "MVP Development" },
    { id: "dashboard", title: "Data Visualization" },
      ...
      <div className="contact-inner__area contact-inner__ptb p-relative theme-bg-2">
        <div className="container">
          <div className="row justify-content-center">
              ...
              <div className="row align-items-center">
                <div className="col-xl-9 col-lg-10">
                  <div className="contact-inner__top-section-title-box mb-70">
                    ...
                    <h4 className="contact-inner__title tp-char-animation tp-hero-3__content" style={{ fontSize: '70px' }}>
                      {title_2}
                    </h4>
                  </div>
                </div>
            ...
            <ContactForm interests={selectedCategories.map(i => categorys[i].title)} />
          </div>
        </div>
      </div>
